...
void comp(){
	...
	string title("");
	title = Form(" RE4/1 190 , FEB 18 , Petiroc 2C, FEBv2_2 - %s ; HVeff; Eff",wp.at(ii));
...
//	ltx_5->DrawLatex(6400, 0.47, Form("HV 50% = %.0f V", p3_5));
        ...
        ltxLeg5->DrawLatex(5950, 1.05, "Source 4.6; 40ns deadtime");
        ...
        string fileName9("");
        fileName9 = Form("Comp_%s.png",wp.at(ii));
